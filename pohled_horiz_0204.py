    ...
    # vytvoreni prazdneho dvourozmerneho pole o velikosti odpovidajici poctu radku a sloupcu vstupnimu rastru vysek
        ...
        for sloupec in range(1, sloupce - 1):                                                     #smycka projizdi vsechny sloupce rastru
            for radek in range(1, radky - 1):                                                     #smycka projizdi vsechny radky rastru
                ...
                maximalniHodnota = max(LevaDolni, LevaHorni, LevaStredni, StredniDolni, StredniHorni, PravaDolni, PravaStredni, PravaHorni)
        ...
        def Akumulace():
            ...
            while index < len(okoliHrbetnic):
                ...
                if Zpracovavana == -9998: #-9998 je nase oznaceni proto, aby nasledna akumulace z okoli nebyla ovlivnena nasim oznacenim
                    ...
                    minAkumulaceZOkoli = max(LevaDolni, LevaHorni, LevaStredni, StredniDolni, StredniHorni, PravaDolni, PravaStredni, PravaHorni)
                    rasterAkumulace[radek][sloupec] = minAkumulaceZOkoli + rasterSnizeni[radek][sloupec]
                if LevaHorni == -9999:      #NODATA
                    #LevaHroni je -9998 proto aby jsme tento bod znovu nepridavali do seznamu (dtto u ostatnich okolnich pixelu)
                    LevaHorni = -9998
